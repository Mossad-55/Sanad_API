...
|---|---:|---|
| Controller actions | 237 | complete |
| Postman API requests | 269 | complete |
...
| Family subscriptions | Plan catalog/current snapshot, quote, payment intent, renewal controls | `FamilySubscriptionsController` | `docs/app/families/subscriptions.md` | Family collection | Subscription tests and Bruno collection |
