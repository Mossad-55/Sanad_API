...
namespace Sanad.Modules.Identity.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260915115100_EnforceCaregiverAccountExclusivity")]
    partial class EnforceCaregiverAccountExclusivity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Sanad.Modules.Identity.Domain.Support.SupportTicket", b =>
                {
                    ...
                    b.ToTable("support_tickets", "identity");
                });
            ...
            modelBuilder.Entity("Sanad.Modules.Identity.Domain.Users.User", b =>
                {
                    ...
                    b.OwnsOne("Sanad.Modules.Identity.Domain.Users.NotificationPreferences", "NotificationPreferences", b1 =>
                        {
                            b1.Property<Guid>("UserId")
                                .HasColumnType("uuid");

                            b1.Property<bool>("BookingUpdates")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("boolean")
                                .HasDefaultValue(true)
                                .HasColumnName("booking_updates");

                            b1.Property<bool>("CheckInAlerts")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("boolean")
                                .HasDefaultValue(true)
                                .HasColumnName("check_in_alerts");

                            b1.Property<bool>("CommunityNotifications")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("boolean")
                                .HasDefaultValue(true)
                                .HasColumnName("community_notifications");

                            b1.Property<bool>("FamilyActivityAlerts")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("boolean")
                                .HasDefaultValue(true)
                            ...
                            b1.Property<bool>("MessagesFromFamilies")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("boolean")
                                .HasDefaultValue(true)
                                .HasColumnName("messages_from_families");

                            b1.Property<bool>("NewOrders")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("boolean")
                                .HasDefaultValue(true)
                                .HasColumnName("new_orders");

                            b1.Property<bool>("SystemNotifications")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("boolean")
                                .HasDefaultValue(true)
